      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl text-center">
          ...
          <div className="flex justify-center mb-8">
            <svg xmlns="http://www.w3.org/2000/svg" width={isMobile ? "80" : "120"} height={isMobile ? "80" : "120"} viewBox="0 0 256 256">
              <defs>
          ...
          <h1 className={`${isMobile ? 'text-4xl' : 'text-6xl'} font-bold text-gray-900 mb-4`}>
            Telegram 下载
          </h1>
          <p className={`${isMobile ? 'text-lg' : 'text-2xl'} text-gray-600 mb-6`}>
            免费、安全、快速的即时通讯应用
          </p>

          {/* Version Badge */}
          <div className={`inline-flex items-center gap-2 bg-telegram-blue text-white ${isMobile ? 'px-4 py-1.5 text-sm' : 'px-6 py-2'} rounded-full mb-8`}>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
              ...
              <h3 className={`${isMobile ? 'text-xl' : 'text-2xl'} font-bold text-gray-900 mb-2 text-center`}>Android</h3>
              <p className={`text-gray-600 text-center mb-4 ${isMobile ? 'text-sm' : ''}`}>{downloads.android.fileSize} • {downloads.android.minVersion}</p>
              <div className="space-y-3">
                {/* Google Play 风格下载页 - 直接下载APK */}
                <a
                  href="/play-download"
                  className={`block w-full bg-green-600 text-white text-center ${isMobile ? 'py-2.5' : 'py-3'} rounded-lg font-semibold hover:bg-green-700 transition shadow-lg`}
                >
                  ...
                  {!isMobile && <span className="text-xs opacity-90">（推荐）APK直接安装</span>}
                </a>
              </div>
            </div>
